...
d_final_pre_regressions %>% 
  select(response_id, quiz_for_correct, quiz_against_correct, treatment_bool) %>% 
  unique() %>% 
  summarise(for_avg = mean(quiz_for_correct),
            against_avg = mean(quiz_against_correct))

# d_final_pre_regressions %>% 
#   select(response_id, quiz_for_correct, quiz_against_correct, treatment_bool) %>% 
#   unique() %>% 
#   t.test(`quiz_for_correct` , `quiz_against_correct`, data = .)
...
stargazer(model_basic,
          ...
          column.labels=c("all","alien","recycle","social media"),
